...
let CustomerController = class CustomerController {
    ...
    async getReviews(id, paginationDto) {
        try {
            ...
            return new globalClass_1.ResponseData(client_1.job, globalEnum_1.HttpStatus.SUCCESS, globalEnum_1.HttpMessage.SUCCESS);
        }
        catch (error) {
            return new globalClass_1.ResponseData(null, globalEnum_1.HttpStatus.ERROR, globalEnum_1.HttpMessage.ERROR);
        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8e3e07973b3f8b08aead")
/******/ })();
/******/ 
/******/ }
;