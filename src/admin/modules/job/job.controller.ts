...
export class JobController {
    ...
    @Get()
    async getJobs(): Promise<ResponseData<JobViewDto[]>> {
        try {
    ...
    async detailGeneralInformation(@Param('id') id: number): Promise<ResponseData<JobDtailGeneralInformationDto>>{
        try {
            const jobDetail = await this.jobService.detailGeneralInformation(id)
